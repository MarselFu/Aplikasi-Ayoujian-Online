<a href="<?=base_url('dashboard')?>" class="logo">
    <span class="logo-mini"><b>AUO</b></span>
    <span class="logo-lg"><b>A</b>yo <b>U</b>jian <b>O</b>nline</span>
</a>
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs">Hallo, <?=$user->first_name?></span>
                </a>
                <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                        ...
                        <p>
                            ...
                            <small>Akun Di Buat Sejak <?=date('M, Y', $user->created_on)?></small>
                        </p>
                    </li>
                    <!-- Menu Body -->
