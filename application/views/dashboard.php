...
<div class="row">
        ...
        <td>
            <ol class="pl-4">
                <?php foreach ($kelas as $k) : ?>
                    <li>
                        <?= $k->nama_kelas ?>
                        <span class="ml-2"><?= $k->nama_jurusan ?></span>
                    </li>
                <?php endforeach; ?>
            </ol>
        </td>
    ...
    <div class="col-sm-8">
        <div class="box box-solid">
            ...
            <div class="box-body">
                <p>Selamat Datang Di Aplikasi Ayo Ujian Online</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-8">
        <div class="box box-solid">
            ...
            <div class="box-body">
                <p>Selamat Datang Di Aplikasi Ayo Ujian Online</p>
                <ul class="pl-4">
                    <li>Kerjakan Ujian Dengan Jujur</li>
                    <li>Jangan Lupa Berdoa Sebelum Memulai Ujian</li>
                </ul>
                <p>Semoga Sukses Dan Jangan Menyerah Tetap Semangat Ya 😊</p>
            </div>
        </div>
    </div>
</div>
