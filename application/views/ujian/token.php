<div class="callout callout-info">
    ...
    <ul class="pl-4">
    <li>Jangan Lupa Memasukan Token</li>       
    <li>Kerjakan Soal Ujian Dengan Jujur</li>
    <li>Ujian Akan Dilakukan Dalam Waktu 60 Menit</li>  
    </ul>
</div>
            ...
            <div class="col-sm-6">
                <div class="box box-solid">
                    <div class="box-body pb-0">
                        <div class="callout callout-info">
                            <p>
                                Waktu ujian akan dimulai saat tombol "MULAI" berwarna hijau.
                            </p>
                        </div>
                        <?php
